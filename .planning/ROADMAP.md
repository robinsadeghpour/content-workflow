...
Plans:
- [x] 06.1-01-PLAN.md — Foundation: schema ALTERs, NotebookLM research bash module, critic rubric JSON
- [x] 06.1-02-PLAN.md — Content orchestrator wiring: Step 1.5 research + critic loop rewrite (replace-not-merge, 2-iter cap, best-iter, flag persistence) + writer brief inlining
- [x] 06.1-03-PLAN.md — Critic agent rewrite: hook/facts/economy dimensions, cut-test, research-brief fact grounding, replace-not-merge revise contract
- [x] 06.1-04-PLAN.md — Dashboard flag surfacing + generate-content skill doc sync
